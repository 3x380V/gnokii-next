/*
  ...
  $Id: nk6510.c,v 1.152 2004-09-12 17:53:33 pkot Exp $
...
gn_driver driver_nokia_6510 = {
	...
	{
		"6510|6310|8310|6310i|6360|6610|6100|5100|3510|3510i|3595|6800|6810|6820|6820b|6610i|6230", /* Supported models */
		7,                     /* Max RF Level */
		0,                     /* Min RF Level */
...
static gn_error SetOperatorBitmap(gn_data *data, struct gn_statemachine *state)
{
	...
	*/
	...
	SEND_MESSAGE_BLOCK(NK6510_MSG_NETSTATUS, req[19] + req[11] + 10);
}
...
static gn_error NK6510_IncomingBattLevel(int messagetype, unsigned char *message, int length, gn_data *data, struct gn_statemachine *state)
{
	...
	case 0x0B:
		...
		*(data->battery_level) = message[9] * 100 / 7;
